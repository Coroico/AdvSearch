...
switch($options[xPDOTransport::PACKAGE_ACTION]) {
    case xPDOTransport::ACTION_INSTALL:
        ...
        if (!is_dir(MODX_ASSETS_PATH . 'libraries/Zend/Search')) {
            $modx->log(xPDO::LOG_LEVEL_INFO,'Zend search library not found in assets/library/Zend - May be you have installed this library somewhere else. Install will continue');
        }
		
		if ($success) $modx->log(xPDO::LOG_LEVEL_INFO,'End of validation. Install package successfull');
		else $modx->log(xPDO::LOG_LEVEL_ERROR,'End of validation. Install package aborted');
        break;
