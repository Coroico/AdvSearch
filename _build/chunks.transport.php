<?php
/**
 * Utility snippet for AdvSearch development
 *
...
$sources= array (
    'root' => $root,
    'build' => $root . '_build/',
    'source_core' => $root . 'core/components/advsearch',
    'source_assets' => $root . 'assets/components/advsearch',
...
$category = $modx->getObject('modCategory', array('category'=>'AdvSearch'));

if (! $category) {
    $category= $modx->newObject('modCategory');
    $category->set('category','AdvSearch');
}
