...
$_lang['advsearch.advsearchform_addJQuery_desc'] = 'If you would like to include or not jQuery library in the header of your pages automatically.';
$_lang['advsearch.advsearchform_addJQueryUI_desc'] = 'If you would like to include or not jQueryUI package in the header of your pages automatically.';
...
$_lang['advsearch.advsearch_showExtract_desc'] = 'Maximum number of extracts displayed for each search result.';
...
$_lang['advsearch.advsearch_urlScheme_desc'] = 'Indicates in what format the URL is generated. (-1, 0, 1, full, abs, http, https)';
